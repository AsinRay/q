...
alias lh='ls -lh'
alias tf='tail -100f'
echo "asdfasdfasdf" >/home/boot/fff.log
...
PATH=/home/boot/.dev/mvn/bin/:$PATH
PATH=/home/boot/.dev/gradle/bin/:$PATH
PATH=/home/boot/.dev/mvn/bin/:$PATH
PATH=/home/boot/.dev/node/bin/:$PATH
PATH=/home/boot/Android/Sdk/platform-tools/:$PATH


export PATH

export SSLKEYLOGFILE=$PATH:~/.dev/node/bin
